...
public class Add_Customer extends JFrame implements ActionListener
{
    ...
    Add_Customer()
    {
        ...
        setLocation(10,10);
        setResizable(false);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("Gym_Management/icons/15.png"));
        ...
        l14=new JLabel("Welcome New Gym Mate");
    ...
    public void actionPerformed(ActionEvent e)
    {
        try
        {
            ...
            if(e.getSource()==bt1)
            {
                ...
                String q="insert into add_customer values('"+id+"','"+name+"','"+fname+"','"+email+"','"+address+"','"+cont+"','"+minag+"','"+gender+"','"+height+"','"+weight+"','"+remarks+"','"+tname+"','"+tcat+"')";
